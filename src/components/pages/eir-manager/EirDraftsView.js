...
const EirDraftsView = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-amber-50/30 to-slate-50" data-page-uri="/eir-manager/drafts">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex items-center gap-3 mb-8">
          <button
            ...
            aria-label="Back to EIR Manager"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">My EIR Drafts</h1>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          ...
          {loading ? (
            ...
            <div className="px-6 py-12 text-center text-gray-500">
              No EIR documents yet. <button type="button" onClick={() => navigate('/eir-manager')} className="text-amber-700 font-medium hover:underline">Create one</button>.
            </div>
          ) : (
